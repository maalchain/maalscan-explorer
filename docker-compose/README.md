...
Runs Maalscan locally in Docker containers with [docker-compose](https://github.com/docker/compose).
...
- Maalscan explorer at http://localhost:4000.
...
You can adjust Maalscan environment variables from `./envs/common-blockscout.env`. Descriptions of the ENVs are available in [the docs](https://docs.blockscout.com/for-developers/information-and-settings/env-variables).
